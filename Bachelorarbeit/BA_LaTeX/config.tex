...
\usepackage[threshold=1]{csquotes} 	% Richtiges Setzen der Anführungszeichen mit \enquote{}
...
\newcommand{\cube}[7]{
	...
	\pgfmathsetmacro{\h}{#4}
	\pgfmathsetmacro{\d}{#5}
	\draw[#6,fill=#7] (0+#1,0+#2,0) -- ++(-#3,0,0) -- ++(0,-#4,0) -- ++(#3,0,0) -- cycle;
	\draw[#6,fill=#7] (0+#1,0+#2,0) -- ++(0,0,-#5) -- ++(0,-#4,0) -- ++(0,0,#5) -- cycle;
	\draw[#6,fill=#7] (0+#1,0+#2,0) -- ++(-#3,0,0) -- ++(0,0,-#5) -- ++(#3,0,0) -- cycle;
}
